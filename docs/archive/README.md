...
| `releases_supporting_artifacts/` | *(R24.7.2)* Contents deleted as redundant; canonical evidence in out/verification/<Release>/notes.md. Folder retained; see INDEX.md. |
