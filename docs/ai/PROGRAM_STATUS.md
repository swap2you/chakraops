...
| R35.0 | **REMEDIATION COMPLETE (pending review)** — blocker fixes; gates green; Cowork UAT pending clean tree | Cursor / Claude / Codex / Cowork | Codex re-review + Cowork UAT + operator approval before final PR |
