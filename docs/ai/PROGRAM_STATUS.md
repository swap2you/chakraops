...
| R35.0 | **ACTIVE** — operational readiness (scheduling, recovery, notifications, backup, runbooks, final handoff) | Cursor / Claude / Codex / Cowork | Implement per RELEASE_PACKET; gates + UAT; single final PR after validation |
